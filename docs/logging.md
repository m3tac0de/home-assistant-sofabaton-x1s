...
This guide shows how to enable detailed logging for the integration, capture the Home Assistant log file or diagnostics, and safely share them. Paths and menu names match Home Assistant 2025.x.
...
5. With hex logging still on, open the **⋮** menu (three dots) on the **Sofabaton X1S** integration card and choose **Download diagnostics**. This downloads the log file we need along with structured diagnostics.
