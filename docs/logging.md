...
5. With hex logging still on, open the three-dot menu on the **Sofabaton X** integration card and choose **Download diagnostics**. This downloads the log file we need along with structured diagnostics.
