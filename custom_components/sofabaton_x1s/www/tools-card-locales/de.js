...
var TOOLS_CARD_STRINGS_DE = {
  ...
  errors: {
    ...
    irLearnNoSocket: "Lernen ist ohne Websocket-Verbindung nicht verf\xFCgbar",
  ...
  backup: {
    ...
    prontoHexHelper: 'Pronto-W\xF6rter im Learned-Format wie "0000 006D 0022 0000 00AB \u2026"; wird automatisch in Sofabaton-Bytes umgewandelt.',
    prontoUnavailable: "Diese Payload l\xE4sst sich nicht als rohe IR-Timings lesen und kann daher nicht als Pronto-Hex angezeigt werden.",
    invalidProntoHex: "Dies ist kein g\xFCltiger Pronto-Code im Learned-Format.",
    descriptorX2Only: "Deskriptive IR-Payloads werden nur auf X2-Hubs unterst\xFCtzt.",
    ...
    learnFromHubDescription: "Der Empf\xE4nger des Hubs wartet auf einen einzelnen Tastendruck einer physischen Fernbedienung, die auf den Hub gerichtet ist.",
    ...
    learnHubArming: "Der Empf\xE4nger des Hubs wird aktiviert\u2026",
    learnHubListening: "Richte die Fernbedienung auf den Hub und dr\xFCcke die Taste einmal.",
    learnHubCountdown: (left) => `Warte auf Signal\u2026 ${left}`,
    learnHubLearned: (timings, khz) => `Von der Fernbedienung gelernt: ${timings} Timings bei ${khz} kHz. Erst testen, dann speichern.`,
    ...
    learnHubInterrupted: (by) => `Anderer Hub-Verkehr hat das Lernfenster beendet (${by}). Lass die gekoppelte Fernbedienung unber\xFChrt und versuche es erneut.`,
    learnHubCancelled: "Lernen abgebrochen.",
    learnHubRefused: "Der Hub ist nicht in den Lernmodus gewechselt. Ist die Sofabaton-App verbunden oder l\xE4uft eine Synchronisierung?",
