...
var TOOLS_CARD_STRINGS_NL = {
  ...
  backup: {
    ...
    prontoHexHelper: 'Pronto-woorden in learned-formaat zoals "0000 006D 0022 0000 00AB \u2026"; worden automatisch omgezet naar Sofabaton-bytes.',
    prontoUnavailable: "Deze payload is niet leesbaar als ruwe IR-timings en kan daarom niet als pronto-hex worden getoond.",
    ...
    learnFromHubDescription: "De ontvanger van de hub wacht op \xE9\xE9n druk op een knop van een fysieke afstandsbediening die op de hub is gericht.",
    ...
    learnHubListening: "Richt de afstandsbediening op de hub en druk \xE9\xE9n keer op de knop.",
    learnHubCountdown: (left) => `Luisteren\u2026 ${left}`,
    learnHubLearned: (timings, khz) => `Geleerd van de afstandsbediening: ${timings} timings op ${khz} kHz. Test het en sla het daarna op.`,
    ...
    learnHubInterrupted: (by) => `Ander hubverkeer heeft het leervenster be\xEBindigd (${by}). Laat de gekoppelde afstandsbediening met rust en probeer het opnieuw.`,
