...
var TOOLS_CARD_STRINGS_NL = {
  ...
  backup: {
    ...
    prontoHexHelper: 'Pronto Hex-waarden in aangeleerd formaat zoals "0000 006D 0022 0000 00AB \u2026" en Unfolded Circle HEX-codes zoals "3;0x4B36D32C;32;0" worden automatisch omgezet naar Sofabaton-bytes.',
    ...
    ucHexUnsupported: (protocol) => `Unfolded Circle HEX-codes voor ${protocol} kunnen nog niet worden omgezet. Exporteer het commando in plaats daarvan als PRONTO.`,
    ucHexUnrepresentable: "Deze Unfolded Circle HEX-code volgt de frameregels van zijn protocol niet en kan daarom niet worden omgezet.",
    ucHexUnavailable: "Voor het omzetten van Unfolded Circle-codes is de bibliotheek infrared-protocols nodig, die in deze Home Assistant niet beschikbaar is.",
