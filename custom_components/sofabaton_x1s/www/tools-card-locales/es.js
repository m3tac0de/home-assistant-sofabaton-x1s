...
var TOOLS_CARD_STRINGS_ES = {
  ...
  backendState: {
    ...
    entityStepRemoteSync: "Sincronizando el control remoto\u2026",
  ...
  backup: {
    ...
    activityShortcutsSubSortable: "Comandos y macros mostrados en la pantalla del control remoto. Arrastra el tirador para reordenarlos.",
    ...
    prontoHexHelper: 'Palabras pronto en formato aprendido como "0000 006D 0022 0000 00AB \u2026"; se convierten autom\xE1ticamente en bytes Sofabaton.',
    prontoUnavailable: "Esta carga \xFAtil no se puede leer como tiempos IR sin procesar, por lo que no puede mostrarse como pronto hex.",
    invalidProntoHex: "Este no es un c\xF3digo pronto v\xE1lido en formato aprendido.",
    ...
    learn: "Aprender",
    learnAria: "Aprender una carga \xFAtil desde un mando o desde Home Assistant",
    learnBack: "Atr\xE1s",
    learnTryAgain: "Reintentar",
    learnFromHub: "Desde un mando",
    learnFromHubDescription: "El receptor del hub espera una sola pulsaci\xF3n de un mando f\xEDsico apuntando al hub.",
    ...
    learnHubListening: "Apunta el mando al hub y pulsa el bot\xF3n una vez.",
    learnHubCountdown: (left) => `Escuchando\u2026 ${left}`,
    learnHubLearned: (timings, khz) => `Aprendido del mando: ${timings} tiempos a ${khz} kHz. Pru\xE9balo y luego guarda.`,
    learnHubLearnedRaw: "Aprendido del mando. Pru\xE9balo y luego guarda.",
    learnHubTimedOut: "No lleg\xF3 ninguna se\xF1al antes de que se cerrara la ventana de aprendizaje del hub.",
    learnHubInterrupted: (by) => `Otro tr\xE1fico del hub cerr\xF3 la ventana de aprendizaje (${by}). No toques el mando emparejado y vuelve a intentarlo.`,
    learnHubCancelled: "Aprendizaje cancelado.",
    learnHubRefused: "El hub no entr\xF3 en modo de aprendizaje. \xBFEst\xE1 conectada la app de Sofabaton o hay una sincronizaci\xF3n en curso?",
  ...
  wifiCommands: {
    ...
    sectionSubtitle: "Usa Wifi Commands para ejecutar acciones de Home Assistant desde los botones de tu control remoto f\xEDsico. Elige un dispositivo Wifi para editar sus espacios de comando o a\xF1ade uno nuevo.",
    ...
    none: "Ninguno",
    commandSlotDescription: "Crea un comando en este espacio. As\xEDgnale un nombre y decide a qu\xE9 actividades aplicarlo. El nombre aparecer\xE1 en la pantalla del control remoto, en la aplicaci\xF3n m\xF3vil y como estado del sensor de Wifi Commands.",
    ...
    wifiEventsSubtitle: "Eventos creados desde el editor de actividades. Pulsarlos en el control remoto dispara aqu\xED su acci\xF3n de Home Assistant (tambi\xE9n actualizan el sensor de Wifi Commands).",
