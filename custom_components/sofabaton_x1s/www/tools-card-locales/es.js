...
var TOOLS_CARD_STRINGS_ES = {
  ...
  backup: {
    ...
    prontoHexHelper: "Los valores Pronto Hex en formato aprendido, como \xAB0000 006D 0022 0000 00AB \u2026\xBB, y los c\xF3digos HEX de Unfolded Circle, como \xAB3;0x4B36D32C;32;0\xBB, se convierten autom\xE1ticamente en bytes Sofabaton.",
    ...
    ucHexConverting: "Convirtiendo el c\xF3digo de Unfolded Circle\u2026",
    ucHexInvalid: "Este no es un c\xF3digo HEX de Unfolded Circle v\xE1lido.",
    ucHexUnknownProtocol: "este protocolo",
    ucHexUnsupported: (protocol) => `Los c\xF3digos HEX de Unfolded Circle para ${protocol} todav\xEDa no se pueden convertir. Exporta el comando como PRONTO en su lugar.`,
    ucHexUnrepresentable: "Este c\xF3digo HEX de Unfolded Circle no respeta las reglas de trama de su protocolo, por lo que no se puede convertir.",
    ucHexUnavailable: "Para convertir c\xF3digos de Unfolded Circle se necesita la biblioteca infrared-protocols, que no est\xE1 disponible en este Home Assistant.",
    ucHexNoHost: "Los c\xF3digos de Unfolded Circle solo se pueden convertir mientras Home Assistant est\xE1 conectado.",
    ucHexFailed: "No se pudo convertir el c\xF3digo de Unfolded Circle.",
