...
var TOOLS_CARD_STRINGS_FR = {
  ...
  backup: {
    ...
    addMemberHelper: "L\u2019appareil est ajout\xE9 aux s\xE9quences d\u2019allumage et d\u2019extinction. Attribuez des touches ou des raccourcis plus tard, ou laissez-le sans.",
  ...
  decodedPayload: {
    ...
    mqttTitle: "Enregistrement MQTT",
    mqttSubtitle: "Les deux octets sont ignor\xE9s par le hub : lors d\u2019un appui, il publie ses propres identifiants d\u2019appareil et de touche vers le broker. Il n\u2019y a rien \xE0 configurer.",
  ...
  wifiCommands: {
    ...
    transportPillPreviewTitle: "Sera d\xE9ploy\xE9 avec ce transport",
