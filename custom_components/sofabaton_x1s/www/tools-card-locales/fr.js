...
var TOOLS_CARD_STRINGS_FR = {
  ...
  backup: {
    ...
    memberSummary: (names) => `Appareils : ${names}`,
    memberSummaryEmpty: "Aucun appareil pour l\u2019instant. Ouvrez une s\xE9quence et utilisez Ajouter un appareil.",
  ...
  wifiCommands: {
    ...
    wifiEventsStaleConfirmText: "Supprimer tous les \xE9v\xE9nements Wifi et leurs actions de Home Assistant ?",
