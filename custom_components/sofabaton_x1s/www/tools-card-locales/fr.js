...
var TOOLS_CARD_STRINGS_FR = {
  ...
  wifiCommands: {
    ...
    inActivities: (count) => `dans ${count} ${count === 1 ? "activit\xE9" : "activit\xE9s"}`,
    ...
    wifiEventDeleteRefs: (favorites, bindings, steps) => `Le hub supprimera aussi ${favorites} ${favorites === 1 ? "raccourci" : "raccourcis"} et ${bindings} ${bindings === 1 ? "attribution de touche" : "attributions de touches"} qui y font r\xE9f\xE9rence\xA0; l\u2019\xE9tape est retir\xE9e de ${steps} ${steps === 1 ? "macro" : "macros"} (une macro sans \xE9tapes est supprim\xE9e).`,
