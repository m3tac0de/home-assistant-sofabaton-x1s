...
var TOOLS_CARD_STRINGS_FR = {
  ...
  backup: {
    ...
    prontoHexHelper: 'Mots pronto au format appris comme "0000 006D 0022 0000 00AB \u2026"\xA0; convertis automatiquement en octets Sofabaton.',
    prontoUnavailable: "Cette charge utile ne se lit pas comme des timings IR bruts et ne peut donc pas \xEAtre affich\xE9e en pronto hex.",
    ...
    learn: "Apprendre",
    learnAria: "Apprendre une charge utile depuis une t\xE9l\xE9commande ou depuis Home Assistant",
    learnBack: "Retour",
    learnTryAgain: "R\xE9essayer",
    learnFromHub: "Depuis une t\xE9l\xE9commande",
    learnFromHubDescription: "Le r\xE9cepteur du hub attend une seule pression sur une t\xE9l\xE9commande physique point\xE9e vers le hub.",
    ...
    learnHubListening: "Pointez la t\xE9l\xE9commande vers le hub et appuyez une fois sur la touche.",
    learnHubCountdown: (left) => `\xC9coute\u2026 ${left}`,
    learnHubLearned: (timings, khz) => `Appris depuis la t\xE9l\xE9commande\xA0: ${timings} timings \xE0 ${khz} kHz. Testez, puis enregistrez.`,
    learnHubLearnedRaw: "Appris depuis la t\xE9l\xE9commande. Testez, puis enregistrez.",
    learnHubTimedOut: "Aucun signal n\u2019est arriv\xE9 avant la fermeture de la fen\xEAtre d\u2019apprentissage du hub.",
    learnHubInterrupted: (by) => `Un autre trafic du hub a mis fin \xE0 la fen\xEAtre d\u2019apprentissage (${by}). Ne touchez pas \xE0 la t\xE9l\xE9commande appair\xE9e et r\xE9essayez.`,
    ...
    learnHubNoPayload: "Le hub a capt\xE9 un signal, mais sa charge utile n\u2019a pas pu \xEAtre lue.",
    ...
    learnHaUnavailable: "Impossible de lire la bo\xEEte de r\xE9ception de l\u2019\xE9metteur.",
