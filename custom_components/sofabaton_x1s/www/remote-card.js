...
var REMOTE_CARD_STRINGS_ES = {
  ...
  assist: {
    ...
    start: "Iniciar",
    waiting: "Esperando que se pulse un bot\xF3n",
    ...
    notification: {
      ...
      lovelaceHeading: "\u{1F4CB} **C\xF3digo del bot\xF3n de Lovelace**",
  ...
  editor: {
    ...
    automationAssistTitle: "Asistente de automatizaci\xF3n",
    ...
    resetDefaultLayout: "Restablecer el dise\xF1o predeterminado",
...
var REMOTE_CARD_STRINGS_FR = {
  ...
  assist: {
    ...
    plusActivityTriggers: (count) => ` ; ${count} ${plural2(count, "d\xE9clencheur")} d\u2019activit\xE9 \xE9galement ${plural2(count, "cr\xE9\xE9")}`,
    ...
    notification: {
      title: "\u{1F6E0}\uFE0F Automation Assist",
      eventButton: (label) => `Touche : ${label}`,
      eventActivity: (label) => `Changement d\u2019activit\xE9 : ${label}`,
      eventOther: (label) => `\xC9v\xE9nement : ${label}`,
      header: (activityName, eventLabel) => `**Activit\xE9 : ${activityName} | ${eventLabel}**`,
  ...
  editor: {
    ...
    dvr: "DVR",
    resetCardDefault: "R\xE9tablir la valeur par d\xE9faut de la carte",
    resetDefaultLayout: "R\xE9tablir la disposition par d\xE9faut",
...
var REMOTE_CARD_STRINGS_ZH_HANS = {
  ...
  assist: {
    ...
    createdActivityTriggers: (count) => `\u5DF2\u4E3A X2 \u2192 Activities \u521B\u5EFA ${count} \u4E2A\u6D3B\u52A8\u89E6\u53D1\u5668`,
  ...
  editor: {
    ...
    keyCapture: "\u6309\u952E\u6355\u83B7",
    keyCaptureDescription: "\u5C06\u6309\u952E\u64CD\u4F5C\u53D1\u9001\u5230 Hub\uFF0C\u4EE5\u751F\u6210\u53EF\u76F4\u63A5\u7528\u4E8E\u4EEA\u8868\u76D8\u6309\u94AE\u548C\u81EA\u52A8\u5316\u7684 YAML\u3002",
